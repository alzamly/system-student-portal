...
class Controller
{
    ...
    {
        require '../app2/models/' . strtolower($model_name) . '.php';
        // return new model (and pass the database connection to the model)
        return new $model_name($this->db);
    }

    // arrays 
    private $school_pages = ["classes"];
    ...
    {
        if(isset($_SESSION['control_pq']))
        {
            //require_once '../app2/views/'. $_SESSION['control_pq'] . '/' . $view . '.php';
            require_once '../app2/views/'. $_SESSION['control_pq'] . '/' . $this->checkPages($_SESSION['sp_perm'], $view) . '.php';
        }
        else
        {
            require_once '../app2/views/' . $_SESSION['control_pq'] . '/' . $view . '.php';  
